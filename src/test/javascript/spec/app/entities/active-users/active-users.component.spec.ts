...
import { ActiveUsersComponent } from 'app/entities/active-users/active-users.component';
...
describe('Component Tests', () => {
    describe('ActiveUsers Management Component', () => {
        let comp: ActiveUsersComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ActiveUsersComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.activeUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
